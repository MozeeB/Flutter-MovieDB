...
class PopulardWidget extends StatelessWidget {

  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      key: UniqueKey(),
      future: MovieDB.getInstance().popularMovies(),
      builder: (BuildContext context, AsyncSnapshot<List<Movie>> snapshot) {
        ...
        print("ini data popular${data.length}");

        return PopularWidgetListWidget(data, "Popular", "popular");
      },
    );
  }
}

class PopularWidgetListWidget extends StatelessWidget {
  final List<Movie> data;
  final String title;
  final String heroKey;

  PopularWidgetListWidget(this.data, this.title, this.heroKey);
