  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<List<Movie>> snapshot) {
        ...
        return UpcomingListWidgetHome(data, "Upcoming Movies", "upcoming");
      },
    );
  }
}

class UpcomingListWidgetHome extends StatelessWidget {
  final List<Movie> data;
  final String title;
  final String heroKey;

  UpcomingListWidgetHome(this.data, this.title, this.heroKey);
